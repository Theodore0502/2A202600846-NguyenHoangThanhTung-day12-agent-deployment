...
from day09_app.config import Settings
from day09_app.state import ShoppingState
from provider import get_chat_model
from day09_app.data_access import ShoppingDataStore, build_data_tools
from rag.embeddings import SentenceTransformerEmbeddings
from rag.vector_store import ChromaPolicyStore
from day09_app.prompts import SUPERVISOR_PROMPT, POLICY_WORKER_PROMPT, DATA_WORKER_PROMPT, RESPONSE_WORKER_PROMPT
...
class ShoppingAssistant:
    def __init__(self, settings: Settings | None = None) -> None:
        ...
        data_path = self.settings.orders_path
        ...
        persist_dir = self.settings.root_dir / "data" / "chroma_db"
